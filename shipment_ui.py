...
def load_shipment_ui(main_content_frame):
    ...
    tree.column("Order No", width=90, anchor=tk.CENTER)
    tree.column("Sender", width=160, anchor=tk.CENTER)
    tree.column("Receiver", width=160, anchor=tk.CENTER)
    tree.column("Date", width=75, anchor=tk.CENTER)
    tree.column("Status", width=80, anchor=tk.CENTER)
    tree.column("Driver", width=90, anchor=tk.CENTER)
    tree.column("Vehicle", width=100, anchor=tk.CENTER)
    tree.column("Cost (£)", width=60, anchor=tk.CENTER)
    tree.column("Surcharges", width=60, anchor=tk.CENTER)
    tree.column("Payment Status", width=70, anchor=tk.CENTER)
    tree.column("Item Desc", width=100, anchor=tk.CENTER)
    tree.column("Incident Report", width=100, anchor=tk.CENTER)

    tree_h_scrollbar = ttk.Scrollbar(table_frame, orient=tk.HORIZONTAL, command=tree.xview)
